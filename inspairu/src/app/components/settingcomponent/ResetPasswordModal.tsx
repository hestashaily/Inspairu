...
import { Closepopup, Resetpass } from "../../icon/route";
...
const ResetPasswordModal: React.FC<ResetPasswordModalProps> = ({
  ...
  // Do not conditionally call hooks. Always call them in the same order.
  ...
  if (!isOpen) return null; // Conditional rendering is fine here
      ...
      <div className="bg-white m-[20px] max-w-[793px] w-full rounded-[12px] p-[32px] relative shadow-lg">
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <div className="flex items-center justify-center flex-col w-full">
            <h2 className="text-[20px] font-semibold text-[#333]">Reset Password</h2>
            <p className="md:mb-[30px] mb-[10px] text-center text-[#666] text-[14px]">
              Your previous password has been reset. Please set a new password for your account.
            </p>
            <form className="flex flex-col w-full gap-[12px]" onSubmit={handleSubmit}>
              <div className="border border-[#E2E8F0] flex items-center justify-between text-[#525252] rounded-[6px] px-[16px] py-[10px] text-[14px]">
                ...
                />
                <Image
                  src={showCurrentPassword ? "/auth-images/eye.png" : "/auth-images/eyeclosed.png"}
                  width={20}
                  height={20}
                  alt="toggle eye"
              ...
              <div className="border border-[#E2E8F0] flex items-center justify-between text-[#525252] rounded-[6px] px-[16px] py-[10px] text-[14px]">
                ...
                />
                <Image
                  src={showNewPassword ? "/auth-images/eye.png" : "/auth-images/eyeclosed.png"}
                  width={20}
                  height={20}
                  alt="toggle eye"
                  className="cursor-pointer ml-2"
