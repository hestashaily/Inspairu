...
const OtpModal: React.FC<OtpModalProps> = ({ isOpen, onClose, onVerify }) => {
  return (
    <div className="fixed inset-0 bg-[#202020D6] z-50 flex justify-center items-center">
      <div className="bg-white max-w-[793px] w-full rounded-[12px] p-[32px] relative shadow-lg text-center">
        ...
        <div className="flex items-center justify-center flex-col">
          ...
          <button
            onClick={onVerify} 
            className="btn-gradient mt-[24px] py-[8px] rounded-[30px] w-full font-[600] text-[16px] text-white cursor-pointer"
          >
            Verify
          </button>
        </div>
        <p className="font-[400] text-start text-[16px] mt-[24px] text-[#525252]">
          Didn’t receive code?{" "}
