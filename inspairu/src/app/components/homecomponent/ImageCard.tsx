...
import { Threedost, Repostdropdown, Report, Share, Like, Comment, Copyclip, Closepopup } from "../../icon";
...
<div  onClick={onClick}>
      ...
      <div className="cursor-pointer">
        <Image src={data.imageSrc} alt="Preview" width={100} height={100} className="w-full min-h-[382px] h-full rounded-[8px] mt-[19px]" />
      </div>
        ...
        <div className="fixed inset-0 bg-[#202020B5] flex items-center justify-center z-50">
          <div className="bg-white rounded-lg p-6 shadow-xl max-w-[437px] w-full text-center relative">
            ...
            <div className="flex w-full items-start justify-start flex-col mt-[35px]">
              <label htmlFor="pageLink" className="font-[500] text-[20px] text-[#525252]">
                Page Link
              </label>
