...
//             <p className="font-[400] text-[12px] text-[#475569]">Audio Content</p>
//           </div>
//         </div>
...
//               <div className="flex w-full flex-col mt-[35px] items-start">
...
type AudioCardProps = {
  ...
  audioSrc: string;
  tags?: string[];
  handleRepost: (data: RepostData) => void;
};
    ...
    <div className="bg-white mt-[27px] rounded-[10px] md:px-[30px] px-[10px] py-[20px]">
      ...
      <div className="mt-[14px] flex items-center md:gap-[23px] gap-[10px] flex-wrap mb-[19px]">
        {tags.map((tag, idx) => (
          <span
            key={idx}
            className="bg-[#F2F2F2] rounded-[33px] py-[8px] px-[18px] font-[500] md:text-[16px] text-[12px] text-[#525252]"
          >
            #{tag}
          </span>
        ))}
