...
import { Commented, Delete, Report, Threedost } from "../../icon/route";
          ...
          <div className="flex items-end justify-end mt-[24px]">
            <div className="max-w-[410px] w-full bg-[#CD508C] p-[12px] rounded-[8px]">
              <p className="font-[400] text-[14px] text-[#FFFFFF]">
                ...
                amet consectetur. Aliquam magna. LoresitAliquam magna Lorem ipsum
                dolor sit amet consectetur. Aliquamagna. Lorem ipsum dolor sit
              </p>
